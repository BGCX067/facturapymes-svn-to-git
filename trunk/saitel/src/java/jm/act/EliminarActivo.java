    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String ids = request.getParameter("c");

            if(objActivo.eliminar(id_sucursal_sesion, ids)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ELIMINACION DEL REGISTRO DE CODIGO(S) " + ids + " EN LA TABLA activo");
                auditoria.cerrar();
                r = "fun»_objT.insertar();";
            }
