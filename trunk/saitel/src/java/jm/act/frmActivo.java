 ...
 * @author Jorge
 */
public class frmActivo extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(id.compareTo("-1")!=0){
                try{
                    ResultSet rsActivo = objActivo.getActivo(Long.parseLong(id));
                    if(rsActivo.next()){
                        ...
                        proveedor = (rsActivo.getString("proveedor")!=null) ? rsActivo.getString("proveedor") : "";
                        rsActivo.close();
                    }
                }catch(Exception e){
                    e.printStackTrace();
            ...
            String html = "obj»"+obj+"^foc»codigo^fun»_objTab.seleccionar(0);^frm»";
            html += "<div class='H3' style='width:450px'>Formulario de Activo</div>";

            html += "<div class='grupoTab' style='width:430px;'><div id='tabR0'>"
                    + "<a id='tab00' href='javascript:void(0);' class='jm_tabAct' onclick='_objTab.seleccionar(0);'>Datos del Activo</a>"
                    + "<a id='tab01' href='javascript:void(0);' class='jm_tab' onclick='_objTab.seleccionar(1);'>Custodios</a></div>";
            ...
            html += "<input type='hidden' id='tipo_pers' name='tipo_pers' value='1' />";
            ...
            /* PRIMER TAB */
            html += "<div id='tab10' class='jm_tabHTML' style='display:block;width:420px;height:"+_altBody+"px;'>";
            html += "<table><tr><td>C&oacute;digo: <span class='marca'>*</span> </td>";
            html += "<td nowrap id=\"axSecCodigos\"><input class='may' id='codigo' name='codigo' type='text' size='35' maxlength='30' value='"+codigo_activo+"' onblur=\"this.value=this.value._trim();\" onkeyup=\"act_getSecCodigo('codigo');\"/></td></tr>";
            ...
            html += "<tr><td nowrap>Proveedor: </td>";
            html += "<td><input id='proveedor' name='proveedor' type='text' size='35' maxlength='100' value='"+proveedor+"' onkeypress=\"_alfanumerico(event);\" onblur=\"this.value=this.value._trim();\" /></td></tr>";
            ...
            ResultSet rsCustodios = objActivo.getCustodiosActivo(id);
            
            html += "<div id='tab11' class='jm_tabHTML' style='display:none;width:420px;height:"+_altBody+"px;'>";

            

            html += "<div id='auxCon' style='width:326px;'>" +
                            "<TABLE cellspacing='0' cellpadding='0'><TR>" +
                            "<TH class='jm_TH' width='70'>DOC.</TH>"+
                            "<TH class='jm_TH' width='170'>RESPONSABLE</TH>" +
                            "<TH class='jm_TH' width='80'>RECEPCION</TH></TR></TABLE>";

            html += "<DIV style='overflow:auto;width:340px;height:"+(_altBody-20)+"px;' id='sll'>" +
            ...
            try{
                ...
                while(rsCustodios.next()){
                    ...
                    html += "<td width='70'>"+((rsCustodios.getString("num_documento")!=null) ? rsCustodios.getString("num_documento") : "")+"</td>";
                    html += "<td width='170'>"+((rsCustodios.getString("persona_recibe")!=null) ? rsCustodios.getString("persona_recibe") : "")+"</td>";
                    html += "<td width='80'>"+((rsCustodios.getString("fecha")!=null) ? rsCustodios.getString("fecha") : "")+"</td>";
                    html += "</tr>";
                    i++;
                }
            }catch(Exception ex){
            ...
            if(id.compareTo("-1")==0 || (id.compareTo("-1")!=0 && objRol.getAcceso(id_rol, "activoEditar"))){
                html += "<input type='submit' value='Guardar' />";
            }
            if(id.compareTo("-1")!=0){
                html += " &nbsp;&nbsp;&nbsp; <input type='button' value='Ver K&aacute;rdex' onclick=\"act_verKardex("+id+")\" />";
            }
