 ...
 * @author Jorge
 */
public class frmFacturaActivoAnular extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(objFacturaCompra.anular(id)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ANULACION DE LA FACTURA DE COMPRA DE ACTIVOS: "+serie_factura+"-"+num_factura + " Y DE TODOS SUS DOCUMENTOS ASOCIADOS");
                auditoria.cerrar();
                r = "err»0^vta»vta1^msg»Se ha anulado la factura y todos sus documentos asociados.";
            }
