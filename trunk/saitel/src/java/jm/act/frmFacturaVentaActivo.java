 ...
 * @author Jorge
 */
public class frmFacturaVentaActivo extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        String p_iva1 = objIva.getMaxPIva();
        ...
        try {
            ...
            if(idFactura.compareTo("-1")!=0){
                try{
                    ...
                    facturaDetalle = objFactura.getFacturaDetalleActivoEdicion(idFactura);
                    ...
                    if(rsFactura.next()){
                        ...
                        subtotal_6 = (rsFactura.getString("subtotal_6")!=null) ? rsFactura.getString("subtotal_6") : "0";
            ...
            /*ResultSet rsProductos = objProducto.getProductosVenta(id_sucursal);
            String json_productos = objProducto.getJSON(rsProductos);
            try{
                rsProductos.close();
            }catch(Exception e){
                e.printStackTrace();
            ...
            out.print("obj»cmp_html^foc»busProd^fun»_objTab.seleccionar(0);^frm»");

            out.print("<div class='grupoTab' style='width:770px;'>"
                    + "<div id='tabR0'>"
            ...
            out.print("<form id='formVenta' action='frmFacturaVentaActivoGuardar' onsubmit='return fac_ventaGuardar(this)' autocomplete='off'>");
            out.print("<input type='hidden' id='idFactura' name='idFactura' value='"+idFactura+"' />"
                    ...
                    + "<input type='hidden' id='idBodEnt' name='idBodEnt' value='' />"
            ...
            out.print("<div style=\"display:none\" id='axCl'></div>" +  /* pongo los datos del cliente buscado */
                    ...
                    "<tr><td align='right'>F A C T U R A &nbsp;&nbsp; D E &nbsp;&nbsp; V E N T A &nbsp;&nbsp; D E &nbsp;&nbsp; A C T I V O S </td>" +
                    ...
                    "<input type='text' size='6' id='nf' name='nf' value='"+num_factura+"' onkeypress=\"_evaluar(event, '0123456789-');\" onkeyup='fac_setDetalle()' /></td></tr>"+
            ...
            out.print("</td>"+
                    ...
                    if(estado_documento.compareTo("a")!=0){
                        out.print("<div id='InAr'><div id='InAr'>B&uacute;squeda de activos: &nbsp; <input type='text' id='busProd' onfocus=\"this.value=''\" style='width:310px;border-color:red' onkeydown='_NoE(event)' onkeyup=\"act_getActivos(event, this.value, 'act_tblActivosVenta', '');\" />"
            ...
            out.print("</td></tr>" +
                    ...
                    "<table id='cab0' cellpadding='0' cellspacing='0'><tr>" +
                    "<TH class='jm_TH' width='160'>C&Oacute;DIGO</TH>" +
                    ...
                    "<DIV id='sll0' style='overflow:auto;width:746px;height:180px;'>" +
            ...
            try{
                ...
                while(facturaDetalle.next()){
                    String id_activo = (facturaDetalle.getString("id_activo")!=null) ? facturaDetalle.getString("id_activo") : "";
                    String codigo_activo = (facturaDetalle.getString("codigo_activo")!=null) ? facturaDetalle.getString("codigo_activo") : "";
                    String precio_costo = (facturaDetalle.getString("precio_costo")!=null) ? facturaDetalle.getString("precio_costo") : "0";
                    //String valor_compra = (facturaDetalle.getString("valor_compra")!=null) ? facturaDetalle.getString("valor_compra") : "0";
                    String cantidad = (facturaDetalle.getString("cantidad")!=null) ? facturaDetalle.getString("cantidad") : "0";
                    String descripcion = (facturaDetalle.getString("descripcion_mas")!=null) ? facturaDetalle.getString("descripcion_mas") : "";
                    ...
                    String total_venta = (facturaDetalle.getString("total")!=null) ? facturaDetalle.getString("total") : "0";
                    
                    clase = i%2==0 ? "jm_filaPar" : "jm_filaImp";
                    
                    html += "<div id='r"+i+"' class='jm_fila "+clase+"'>";
                    html += "<div class='jm_columna caja' style='width:160px' id='cF"+i+"0'>"+codigo_activo+"</div>" +
                        "<div class='jm_columna caja' style='width:226px'><textarea id='cpt"+i+"' name='cpt"+i+"' style='width:210px;height:26px' onblur=\"this.value=this.value._trim();\">"+descripcion+"</textarea>"+
                        "<input type='hidden' id='idPr"+i+"' name='idPr"+i+"' value='"+id_activo+"' />"+ 
                        "<input type='hidden' id='idAc"+i+"' name='idAc"+i+"' value='"+id_activo+"' />"+
                        "<input type='hidden' id='p_iva"+i+"' value='"+p_iva1+"' />"+
                        "<input type='hidden' id='p_c"+i+"' name='p_c"+i+"' value='"+precio_costo+"' />"+
                        "</div>"+
                        "<div class='jm_columna caja' style='width:40px'><input type='text' size='2' id='c"+i+"' name='c"+i+"' value='"+cantidad+"' readonly /></div>"+
                        "<div class='jm_columna caja' style='width:60px'><input type='text' onkeypress=\"_evaluar(event,'0123456789.')\" value='"+p_u+"' size='5' id='pu"+i+"' name='pu"+i+"' style='text-align:right' onkeyup=\"act_calcTotales('', "+i+");fac_sumValores('');\" onblur=\"act_calcTotales('', "+i+");\" /></div>" +
                        "<div class='jm_columna der' style='width:70px'><input type='text' size='5' id='st"+i+"' name='st"+i+"'  value='"+p_st+"' readonly style='text-align:right' /></div>" +
                        //"<div class='jm_columna der' style='width:60px'><input type='text' size='5' id='d"+i+"' name='d"+i+"' value='0' style='text-align:right' onkeyup=\"act_calcTotales('', "+i+")\" /></div>" +
                        //"<div class='jm_columna der' style='width:60px'><input type='text' size='5' id='v"+i+"' name='v"+i+"' value='"+iv+"' style='text-align:right' onkeyup=\"act_calcIva('"+i+"', "+i+");fac_sumValores('');\" /></div>" +
                        "<div class='jm_columna der' style='width:60px'><input type='text' size='5' id='v"+i+"' name='v"+i+"' value='"+iva+"' style='text-align:right' readonly /></div>" +
                        "<div class='jm_columna der' style='width:80px'><input type='text' size='8' id='t"+i+"' name='t"+i+"'  value='"+total_venta+"' readonly style='text-align:right' /></div>" +
                        "<div class='jm_columna der' style='width:20px' align='center'><div class='jm_icoCon' style='background-position:-545px -18px;' title='Eliminar' onclick=\"_R('"+i+"r"+i+"');fac_sumValores('');\">&nbsp;</div></div>";
                    html += "</div>";
                    i++;
                }
            }catch(Exception e){
...
/*
            ...
            if(idFactura.compareTo("-1")!=0){
                ...
                out.println("<br /><table cellpadding='0' cellspacing='0'>"+
                    ...
                    "<DIV id='sll0' style='overflow:auto;width:746px;height:170px;'>" +
                ...
                try{
                    ...
                    if(id_nota_credito_venta.compareTo("")==0){
                        ...
                        while(facturaDetalle.next()){
                            ...
                            html += "<td width='160' id='cF"+i+"0'>"+((facturaDetalle.getString("codigo")!=null) ? facturaDetalle.getString("codigo") : "")+"</td>";
                            html += "<td width='226'>"+((facturaDetalle.getString("descripcion_mas")!=null) ? facturaDetalle.getString("descripcion_mas") : "")+"</td>";
                        ...
                        while(rsNotaCreditoDetalle.next()){
                            ...
                            html += "<td width='160' id='cF"+i+"0'>"+((rsNotaCreditoDetalle.getString("codigo")!=null) ? rsNotaCreditoDetalle.getString("codigo") : "")+"</td>";
                ...
                out.print("<table cellpadding='0' cellspacing='0'>" +
                    ...
                    if(id_nota_credito_venta.compareTo("")==0){
                        ...
                        out.print("<tr class='jm_filaPar'><td colspan='2' align='right'><input type='button' value='Re-imprimir Nota de cr&eacute;dito' onclick=\"imprimir('pdfNotaCredito?id="+id_nota_credito_venta+"');\" /></td></tr>");
                    }
...
/*
            ...
            out.print("</td></tr>" +
                ...
                "<tr class='jm_filaPar' align='right'><td>IVA 12%</td>" +
                "<td><input type='text' style='text-align:right' size='13' maxlength='50' id='ndIva12' name='ndIva12' value='"+nd_iva_12+"' onkeypress=\"_evaluar(event, '0123456789.');\" /></td></tr>"+

                "<tr class='jm_filaPar' align='right'><td>IVA 0%</td>" +
                "<td><input type='text' style='text-align:right' size='13' maxlength='50' id='ndIva0' name='ndIva0' value='"+nd_iva_0+"' onkeypress=\"_evaluar(event, '0123456789.');\" /></td></tr>"+
                ...
                if(id_nota_credito_venta.compareTo("")==0){
                    ...
                    /*if(idFactura.compareTo("-1")!=0 && objRol.getAcceso(id_rol, "ventaAnular")){
                        ...
                        if(fecha_sistema==fecha_asiento || objFactura.fechaAnulacion(idFactura)){
                            out.println("<td align='right'><input type='button' value='Anular Factura' onclick='act_ventaAnular("+idFactura+");' /></td>");
                        }
                    }*/
                    if(estado_documento.compareTo("a")!=0 && !anulado){
                        out.println("<td align='right'>"
                                + "<input type='checkbox' id='genNewClave' name='genNewClave' /> <span class='marca'>Generar nueva clave de acceso </span>&nbsp;"
                                + "<input type='submit' value='Guardar' onclick=\"_('imp').value=1;this.disabled=true;\" /></td>");
                    }
                    /*if(idFactura.compareTo("-1")==0){
                        out.println("<td align='right'><input type='submit' value='Guardar' onclick=\"_('imp').value=0;this.disabled=true;\" /></td>");
