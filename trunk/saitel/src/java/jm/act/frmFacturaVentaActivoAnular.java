 ...
 * @author Jorge
 */
public class frmFacturaVentaActivoAnular extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String serie_factura = request.getParameter("ser");
            String num_factura = request.getParameter("num");

            String r = "msg»Ha ocurrido un error inesperado, por favor, vuelva a intentarlo más tarde o " +
                "contáctese con el administrador del sistema para mayor información.";

            String id_personalizacion = objActivo.anular(id);
            if(id_personalizacion.compareTo("-1")!=0){
                ...
                auditoria.cerrar();
                r = "err»0^vta»cmp^fun»imprimir('pdfPersonalizacion?id="+id_personalizacion+"');^msg»Se ha anulado la factura y todos sus documentos adjuntos.";
            }
