 ...
 * @author Jorge
 */
public class frmPerdidaActivoAnular extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(id_activo_perdida.compareTo("-1")!=0){
                if(objActivo.anularVaja(id_activo_perdida)){
                    Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                    auditoria.setRegistro(request, "ANULACION DE VAJA DEL ACTIVO");
                    auditoria.cerrar();
                    r = "err»0^vta»cmp^tbl»"+objActivo.paginar("vta_activo_perdida", "id_activo_perdida,codigo_activo,categoria,descripcion,toDateSQL(fecha_registro),valor_perdida", "", 0, 100)+"^msg»Anulación de vaja de activo registrada satisfactoriamente.";
                }
            }
