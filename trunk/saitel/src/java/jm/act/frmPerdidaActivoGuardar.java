 ...
 * @author Jorge
 */
public class frmPerdidaActivoGuardar extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(id_activo.compareTo("-1")!=0){
                if(objActivo.darVaja(id_sucursal, id_activo, usuario, perdida, motivo)){
                    Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                    auditoria.setRegistro(request, "VAJA DEL ACTIVO: "+descripcion);
                    auditoria.cerrar();
                    r = "err»0^vta»cmp^tbl»"+objActivo.paginar("vta_activo_perdida", "id_activo_perdida,codigo_activo,categoria,descripcion,toDateSQL(fecha_registro),valor_perdida", WHERE, Integer.parseInt(p), 100)+"^msg»Información ingresada satisfactoriamente.";
                }
            }
