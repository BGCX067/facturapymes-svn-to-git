 ...
 * @author Jorge
 */
public class frmPersonalizacion extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(id.compareTo("-1")!=0){
                try{
                    ...
                    if(rsDocumento.next()){
                        ...
                        bodega_entrega = (rsDocumento.getString("bodega_entrega")!=null) ? rsDocumento.getString("bodega_entrega") : "";
                        ...
                        g_envio = (rsDocumento.getString("gestion_envio")!=null) ? rsDocumento.getString("gestion_envio") : "";
            ...
            out.print("obj»cmp_html^foc»bodega_entrega^frm»"
                    ...
                    "<input id='imp' name='imp' type='hidden' value='0' />" +
                    "<input id='tope' name='tope' type='hidden' value='0' />" +

                    "<table width='795'><tr><td align='center' colspan='2'><strong>FORMULARIO DE MOVIMIENTO DE ACTIVOS</strong></td>" +
            ...
            try{
                ...
                int i=0;
                String clase = "";
                while(rsDocumentoDetalle.next()){
                    clase = i%2==0 ? "jm_filaPar" : "jm_filaImp";
                    DecimalFormat df = new DecimalFormat("0.00"); 
                    id_activo = (rsDocumentoDetalle.getString("id_activo")!=null) ? rsDocumentoDetalle.getString("id_activo") : "";
                    codigo = (rsDocumentoDetalle.getString("codigo_activo")!=null) ? rsDocumentoDetalle.getString("codigo_activo") : "";
                    descripcion = (rsDocumentoDetalle.getString("descripcion")!=null) ? rsDocumentoDetalle.getString("descripcion") : "";
                    valor_compra = (rsDocumentoDetalle.getString("valor_compra")!=null) ? rsDocumentoDetalle.getString("valor_compra") : "";
                    iva = (rsDocumentoDetalle.getString("iva")!=null) ? rsDocumentoDetalle.getString("iva") : "";
                    valor_depreciado = (rsDocumentoDetalle.getString("valor_depreciado")!=null) ? rsDocumentoDetalle.getString("valor_depreciado") : "";
                    out.print("<tr id='r"+i+"' class='"+clase+"'>");
                    out.print("<td width='150' id='cF"+i+"0'>"+codigo+"</td>");
