 ...
 * @author Jorge
 */
public class frmPersonalizacionAceptar extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            "contáctese con el administrador del sistema para mayor información.";
            if(id.compareTo("-1")!=0){
                if(objActivo.aceptarPersonalizacion(id)){
                    Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                    auditoria.setRegistro(request, "ACEPTACION DE DOCUMENTO DE PERSONALIZACION DE ACTIVOS Nro.: "+num_documento);
                    auditoria.cerrar();
                    r = "err»0^vta»cmp^fun»imprimir('pdfPersonalizacion?id="+id+"');"+
                        "^tbl»"+objActivo.paginar("vta_activo_personalizacion", "id_activo_personalizacion,num_documento,persona_recibe,fecha,txt_tipo_movimiento", WHERE, Integer.parseInt(p), 100)+
