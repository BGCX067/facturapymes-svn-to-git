 ...
 * @author Jorge
 */
public class getBodegas extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ResultSet rsBodegas = objBodega.getBodegasPersonalizacion(texto.toLowerCase());
            out.print("fun»"+funcion+"('"+objBodega.getJSON(rsBodegas)+"', '"+obj+"')");
            try{
                rsBodegas.close();
            }catch(Exception e){
                e.printStackTrace();
