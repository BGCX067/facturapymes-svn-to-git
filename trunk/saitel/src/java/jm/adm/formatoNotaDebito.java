 ...
 * @author Jorge
 */
public class formatoNotaDebito extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        int frt_not_deb_anch_concepto = 225;
        int anchos = 225;
        ...
        try{
            ...
            if(rsSucursal.next()){
                ...
                frt_not_deb_anch_concepto = rsSucursal.getString("frt_not_deb_anch_concepto")!=null ? rsSucursal.getInt("frt_not_deb_anch_concepto") : 225;
                anchos = frt_not_deb_anch_concepto + 42;
                rsSucursal.close();
            }
        }catch(Exception e){
            e.printStackTrace();
        ...
        String v_ruc[] = frt_not_deb_ruc.split(":");
        String v_fech_emi[] = frt_not_deb_fecha.split(":");
        String v_direccion[] = frt_not_deb_modifica.split(":");
        String v_detalle[] = frt_not_deb_concepto.split(":");
        String v_subtotal[] = frt_not_deb_valor.split(":");
        ...
        try {
            out.println("<html>");
            out.println("<head>");
            out.println("<title>FORMATO DE NOTA DE DEBITO</title>");
            out.println("<script>var documento='d';"+
                    "var id="+id+";" +
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<button id='imp' onclick=\"window.open('pdfNotaDebito?id=-2', '_blank', 'top=5,left=50,width=750,height=500,location=no');\">Imprimir nota de d&eacute;bito de prueba</button>");
            out.println("<span id='frt_not_deb_razon_social' onmouseover=\"this.className='txt';\" onmouseout=\"this.className=''\" onmousedown=\"iniMover(event, 'frt_not_deb_razon_social');\" title=\"nombre / raz&oacute;n social\">RAZON SOCIAL</span>");
            out.println("<span id='frt_not_deb_ruc' onmouseover=\"this.className='txt';\" onmouseout=\"this.className=''\" onmousedown=\"iniMover(event, 'frt_not_deb_ruc');\" title=\"ci o ruc\">9999999999 </span>");
            out.println("<span id='frt_not_deb_fecha' onmouseover=\"this.className='txt';\" onmouseout=\"this.className=''\" onmousedown=\"iniMover(event, 'frt_not_deb_fecha');\" title=\"fecha de emisi&oacute;n\">01/01/2010 </span>");
            out.println("<span id='frt_not_deb_modifica' onmouseover=\"this.className='txt';\" onmouseout=\"this.className=''\" onmousedown=\"iniMover(event, 'frt_not_deb_modifica');\" title=\"comprobante que modifica\">Factura No. 000-000-0 </span>");
            out.println("<table height='50' cellpadding='0' cellspacing='0' style='width:"+anchos+"px;' id='frt_not_deb_concepto' "
                    + "onmouseover=\"this.className='txt1';_('r1').className='red';\" onmouseout=\"this.className=_('r1').className='';\">"+
                    "<tr valign='top'>" +
                    "<td id='frt_not_deb_anch_concepto' style='width:"+frt_not_deb_anch_concepto+"px;' onmousedown=\"iniMover(event, 'frt_not_deb_concepto');\">RAZON DE LA MODIFICACION</td>"
                    + "<td id='r1' width='10' onmousedown=\"iniRedimensionar('frt_not_deb_anch_concepto')\">&nbsp;</td>"+
                    "</tr></table>");
            out.println("<span id='frt_not_deb_valor' class='txt2' onmouseover=\"this.className='txt3';\" onmouseout=\"this.className='txt2'\" onmousedown=\"iniMover(event, 'frt_not_deb_valor');\" title=\"valor\"> 100,00 </span>");
            out.println("<span id='frt_not_deb_iva_0' class='txt2' onmouseover=\"this.className='txt3';\" onmouseout=\"this.className='txt2'\" onmousedown=\"iniMover(event, 'frt_not_deb_iva_0');\" title=\"IVA 0%\"> 0,00 </span>");
            out.println("<span id='frt_not_deb_iva_12' class='txt2' onmouseover=\"this.className='txt3';\" onmouseout=\"this.className='txt2'\" onmousedown=\"iniMover(event, 'frt_not_deb_iva_12');\" title=\"IVA 12%\"> 12,00 </span>");
            out.println("<span id='frt_not_deb_total' class='txt2' onmouseover=\"this.className='txt3';\" onmouseout=\"this.className='txt2'\" onmousedown=\"iniMover(event, 'frt_not_deb_total');\" title=\"total\"> 112,00 </span>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            objSucursal.cerrar();
