 ...
 * @author Jorge
 */
public class pdfHorario extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        ResultSet registros = objDB.consulta("select sucursal,nombre, modal,estado_horario from vta_horario "+WHERE+" order by sucursal,estado_horario,modal");
        String subtitulo = "HORARIOS.";
        Reporte reporte = new Reporte(false, logo, titulo, ruc, subtitulo, direccion, sucursal,  rep_pie);
        String [] cabTabla = new String [] {"Nro."," #", "NOMBRE DEL HORARIO", "MODALIDAD ", "SUCURSAL.", "ESTADO"};
        float [] anchoTabla = new float[]{5f,5f,50f,10f,10f};
