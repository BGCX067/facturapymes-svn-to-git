 ...
 * @author Jorge
 */
public class pdfHorarioEmpleado extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        ResultSet registros = objDB.consulta("select nombre, empleado, modal, rol , departamento, sucursal from vta_horarioempleado "+WHERE+" order by sucursal,modal");
        String subtitulo = "HORARIOS.";
        Reporte reporte = new Reporte(false, logo, titulo, ruc, subtitulo, direccion, sucursal,  rep_pie);
        String [] cabTabla = new String [] {"Nro."," #", "EMPLEADO", "MODALIDAD ", "ROL.", "DEPARTAMENTO","SUCURSAL"};
        float [] anchoTabla = new float[]{5f,5f,40f,10f,20f,20f,10f};
