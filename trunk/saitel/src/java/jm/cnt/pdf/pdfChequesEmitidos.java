 ...
 * @author Jorge
 */
public class pdfChequesEmitidos extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        ResultSet registros = objComprobanteEgreso.consulta("SELECT ci_ruc, orden_de, banco, cuenta, num_cheque, valor_son, todatesql(fecha_actual), todatesql(fecha_proceso) FROM tbl_comprobante_egreso "
        ...
        String subtitulo = "Cheques Emitidos desde "+fini+" hasta "+ffin;
        ...
        float anchoTabla[] = new float[]{20f,50f,140f,60f,40f,40f,40f,40f,40f};
