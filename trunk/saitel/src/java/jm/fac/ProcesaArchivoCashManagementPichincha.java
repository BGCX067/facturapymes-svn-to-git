 ...
 * @author Jorge
 */
public class ProcesaArchivoCashManagementPichincha extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(archivo.subir(request, 30, new String[]{"text/plain", "text/csv", "application/vnd.ms-excel"} )){
                        ...
                        if(cols.length > 5){
                            if(cols[5].indexOf("PROCESO OK")>=0){
                                ...
                                if(!objCash.hayCuenta(id_sucursal, id_instalacion, periodo)){
                                    ...
                                    + "values("+id_sucursal+", "+id_instalacion+", '"+periodo+"', '"+fecha_pago+"', '"+hora_pago+"', 'PICHINCHA');");
                                }
                            }
                        }
                    }
                ...
                r = "<script language='javascript' type='text/javascript'>window.top.window.fac_PichinchaCashBuscar();window.top.window.fac_finTransferencia("+err+", '"+
