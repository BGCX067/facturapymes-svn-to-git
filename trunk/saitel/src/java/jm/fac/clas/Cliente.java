...
public class Cliente extends DataBase{
    ...
    public String insertar(int id_sucursal, String establecimiento, String tipo_documento, String ruc, String raz, String fecha_nacimiento, String id_plan_cuenta, String dir, String pai, String pro, String ciu,
            ...
            String forma_pago, String tipo_cuenta, String tipo_tarjeta_credito, String tarjeta_credito_caduca, String num_cuenta)
    {
        ...
        return this.insert("INSERT INTO tbl_cliente(id_sucursal, establecimiento, tipo_documento, ruc, razon_social, fecha_nacimiento, id_plan_cuenta, "
                ...
                ", '"+dir+"', '"+pai+"', "+pro+", "+ciu+", '"+carne_conadis+"', '"+tel+"', '"+tel_cl+"', '"+tel_mo+"', '"+fax+"', '"+mail+"', '"+web+
    ...
    public boolean actualizar(String id, String establecimiento, String tipo_documento, String ruc, String raz, String fecha_nacimiento, String id_plan_cuenta, String dir, String pai, String pro, String ciu,
            String carne_conadis, String tel, String tel_cl, String tel_mo, String fax, String mail, String web, String con, String obs, String tipo_doc_debito, String documento, String cliente_debito, 
            String forma_pago, String tipo_cuenta, String tipo_tarjeta_credito, String tarjeta_credito_caduca, String num_cuenta)
    {
        fecha_nacimiento = fecha_nacimiento.compareTo("")!=0 ? "'"+fecha_nacimiento+"'" : "NULL";
        ...
        return this.ejecutar("UPDATE tbl_cliente SET establecimiento='"+establecimiento+"', tipo_documento='"+tipo_documento+"', ruc='"+ruc+
                "', razon_social='"+raz+"', fecha_nacimiento="+fecha_nacimiento+", id_plan_cuenta="+id_plan_cuenta+", direccion='"+dir+
