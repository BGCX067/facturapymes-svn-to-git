 ...
 * @author Jorge
 */
public class frmArqueoAnular extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(objArqueoCaja.anular(id)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ANULACION DEL ARQUEO DE CAJA No." + num);
                auditoria.cerrar();
                r = "err»0^vta»cmp^msg»Se ha anulado el arqueo de caja No. " + num;
            }
