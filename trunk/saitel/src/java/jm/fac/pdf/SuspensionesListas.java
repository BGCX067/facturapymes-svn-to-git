 ...
 * @author Jorge
 */
public class SuspensionesListas extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        response.setHeader("Content-disposition", "attachment; filename=suspensiones_listas_"+Fecha.getFecha("ISO")+"_"+Fecha.getHora()+".txt;");
        ...
        try {
            ...
            try{
                ...
                while(res.next()){
                    ...
                    txt += "add address="+ip+" comment=\""+cliente+"\" disabled=no list=cortados\n";
                }
                res.close();
            }catch(Exception e){
                e.printStackTrace();
