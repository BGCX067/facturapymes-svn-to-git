 ...
 * @author Jorge
 */
public class pdfCambioCliente extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try{
            ResultSet res = objDocumento.getDocumento("r");
            if(res.next()){
        ...
        String numero_instalacion = "";
        String ruc_anterior = "";
        String cliente_anterior = "";
        String ruc_nuevo = "";
        String cliente_nuevo = "";
        String ip = "";
        try{
            ResultSet res = objInstalacion.getCambioCliente(id);
            if(res.next()){
                fecha_solicitud = res.getString("fecha")!=null ? res.getString("fecha") : "";
                id_instalacion = res.getString("id_instalacion")!=null ? res.getString("id_instalacion") : "";
                ruc_anterior = res.getString("ruc")!=null ? res.getString("ruc") : "";
                cliente_anterior = res.getString("razon_social")!=null ? res.getString("razon_social") : "";
                res.close();
            }
        }catch(Exception e){
            e.printStackTrace();
        ...
        try{
            ...
            if(res.next()){
                numero_instalacion = res.getString("numero_instalacion")!=null ? res.getString("numero_instalacion") : "";
                ruc_nuevo = res.getString("ruc")!=null ? res.getString("ruc") : "";
                cliente_nuevo = res.getString("razon_social")!=null ? res.getString("razon_social") : "";
                direccion_instalacion = res.getString("direccion_instalacion")!=null ? res.getString("direccion_instalacion") : "";
        ...
        documento = documento.replace("<<CLIENTE_ACTUAL>>", cliente_anterior);
        documento = documento.replace("<<CLIENTE_FIRMA>>", Cadena.capital(cliente_anterior));
        documento = documento.replace("<<RUC_ACTUAL>>", ruc_anterior);
        documento = documento.replace("<<NUM_INSTALACION>>", numero_instalacion);
        documento = documento.replace("<<DIR_INSTALACION>>", direccion_instalacion);
        documento = documento.replace("<<CLIENTE_NUEVO>>", cliente_nuevo);
        documento = documento.replace("<<RUC_NUEVO>>", ruc_nuevo);

        documento += "\nIP: "+ip;

        CambioCliente obj = new CambioCliente();
