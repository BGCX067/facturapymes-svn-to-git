 ...
 * @author Jorge
 */
public class pdfCambioPlan extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try{
            ResultSet res = objDocumento.getDocumento("m");
            if(res.next()){
        ...
        String ip = "";
        try{
            ResultSet res = objInstalacion.getCambioPlan(id);
            if(res.next()){
        ...
        documento = documento.replace("<<PLAN_NUEVO>>", plan.toUpperCase());

        documento += "\nIP: "+ip;

        CambioPlan obj = new CambioPlan();
