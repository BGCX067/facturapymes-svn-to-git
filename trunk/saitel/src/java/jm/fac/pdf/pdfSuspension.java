    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try{
            ...
            if(res.next()){
                tipo = res.getString("tipo")!=null ? res.getString("tipo") : "t";
                txt_tiempo = res.getString("txt_tiempo")!=null ? res.getString("txt_tiempo") : "";
                fecha_solicitud = res.getString("fecha_solicitud")!=null ? res.getString("fecha_solicitud") : "";
        ...
        try{
            ResultSet res = objDocumento.getDocumento(tipo.compareTo("t")==0?"s":"d");
            if(res.next()){
        ...
        try{
            ...
            if(res.next()){
                id_plan_actual = res.getString("id_plan_actual")!=null ? res.getString("id_plan_actual") : "";
