 ...
 * @author Jorge
 */
public class frmHojaRutaRevisionGuardar extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            while(request.getParameter("id_ots"+i) != null){
                ...
                revision = request.getParameter("rev"+i);
                motivo = request.getParameter("mot"+i).replace("\n", "").replace("\t", "") + ".";
            ...
            if(objHojaRuta.revision(id, usuario)){
                ...
                auditoria.setRegistro(request, "REGISTRO DE REVISION DE LA HOJA DE RUTA NRO. " + num_hoja_ruta);
                auditoria.cerrar();
                ...
                r = "err»0^vta»cmp^tbl»"+objOrdenTrabajo.paginar("vta_hoja_ruta", "id_hoja_ruta,toDateSQL(fecha),tecnico,observacion", WHERE, Integer.parseInt(p), 100)+
                    "^msg»Hoja de ruta revisada satisfactoriamente.";
            }
            objHojaRuta.cerrar();
            out.print(r);
