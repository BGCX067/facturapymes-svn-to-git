 ...
 */
public class EliminarCustodio extends HttpServlet {
...
*/
    ...
    throws ServletException, IOException {
        ...
        String res = "fun»inv_getCustodios("+idAct+");";
        DataBase db = new DataBase(this._ip, this._puerto, this._db, usuario, clave);
        try{
            if(db.ejecutar("delete from tbl_activo_custodio WHERE id_activo_custodio="+id)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ELIMINACION DEL REGISTRO DE CODIGO " + id + " EN LA TABLA activo_custodio");
                auditoria.cerrar();
            }
        }catch(Exception e){
