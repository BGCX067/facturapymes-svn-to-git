 ...
 * @author Jorge
 */
public class ProcesaFacturaCompra extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(archivo.subir(request, 30, new String[]{"text/plain", "text/xml"} )){
                String nom_arch = archivo.getNombreArchivo();
                r = "<script language='javascript' type='text/javascript'>window.top.window.inv_setFacturaProveedor(0, '"+nom_arch+"');</script>";
            }else{
