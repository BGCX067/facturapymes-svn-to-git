 ...
 * @author Jorge
 */
public class frmFacturaCompraAnular extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String num_factura = "";
            try{
                ResultSet rsFactura = objFacturaCompra.getFactura(id);
                if(rsFactura.next()){
            ...
            if(objFacturaCompra.anular(id, descargar_kardex)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ANULACION DE LA FACTURA DE COMPRA: "+serie_factura+"-"+num_factura + " Y DE TODOS SUS DOCUMENTOS ASOCIADOS");
                auditoria.cerrar();
                r = "err»0^vta»cmp^msg»Se ha anulado la factura y todos sus documentos asociados.";
            }
