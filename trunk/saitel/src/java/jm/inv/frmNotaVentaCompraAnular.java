 ...
 * @author Jorge
 */
public class frmNotaVentaCompraAnular extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try{
                ResultSet rsFactura = objNotaVenta.getNotaVenta(id);
                if(rsFactura.next()){
                    serie_nota = (rsFactura.getString("serie_nota")!=null) ? rsFactura.getString("serie_nota") : "001-001";
                    num_nota_venta = (rsFactura.getString("num_nota_venta")!=null) ? rsFactura.getString("num_nota_venta") : "";
                    rsFactura.close();
                }
            }catch(Exception e){
                e.printStackTrace();
            ...
            if(objNotaVenta.anular(id)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ANULACION DE LA LIQUIDACION DE COMPRA O SERVICIO: "+serie_nota+"-"+num_nota_venta + " Y DE TODOS SUS DOCUMENTOS ASOCIADOS");
                auditoria.cerrar();
                r = "err»0^vta»vta1^msg»Se ha anulado la nota de venta y todos sus documentos asociados.";
            }
