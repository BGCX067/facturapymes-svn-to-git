 ...
 * @author Jorge
 */
public class frmPedidoActivo extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            int num_pedido = objActivo.getNumPedido();
            ...
            /*if(id.compareTo("-1")==0){
                ResultSet rsActivos = objActivo.getActivos();
                json_productos = objActivo.getJSON(rsActivos);
                try{
                    rsActivos.close();
                }catch(Exception e){
                    e.printStackTrace();
            ...
            out.print("fun»inv_buscarPedidos()^obj»cmp_html^foc»dt^frm»"
                    ...
                    "<table width='510'><tr><td align='center'><strong>ORDEN DE PEDIDO DE ACTIVOS</strong></td>" +
            ...
            if(id.compareTo("-1")==0){
                out.println("<div><a href='javascript:void(0);' style='float:left;' onclick=\"filtrarActivo();\">Insertar Activos</a> " +
            ...
            out.print("<table cellpadding='0' cellspacing='0'><tr>" +
                    ...
                    "<TH class='jm_TH' width='60'>PEDIDO</TH>"+ 
                    "<TH class='jm_TH' width='60'>Nº Elementos</TH>"+ 
                    "<TH class='jm_TH' width='20'>&nbsp;</TH></tr></table>" +
                    
                    "<DIV style='overflow:auto;width:548px;height:195px;'>" +
            ...
            try{
                ...
                while(rsPedidoDetalle.next()){
                    ...
                    id_pedido_detalle = (rsPedidoDetalle.getString("id_pedido")!=null) ? rsPedidoDetalle.getString("id_pedido") : "";
                    codigo = (rsPedidoDetalle.getString("codigo")!=null) ? rsPedidoDetalle.getString("codigo") : "";
                    descripcion = (rsPedidoDetalle.getString("nombre")!=null) ? rsPedidoDetalle.getString("nombre") : "";
                    cantidad = (rsPedidoDetalle.getString("cantidad")!=null) ? rsPedidoDetalle.getString("cantidad") : "";
                    out.println("<tr id='r"+i+"' class='"+clase+"'>");
                    out.println("<td width='100' id='cF"+i+"0'>"+codigo+"</td>");
                    out.println("<td width='300'><input type='hidden' id='idPeD"+i+"' value='"+id_pedido_detalle+"' /> "+descripcion+"</td>");
                    out.println("<td width='50'>"+cantidad+"</td>");
                    out.println("<td width='50'>"+cantidad+"</td>");
            ...
            out.println("<table class='jm_tabla' width='548' cellspacing='0' cellpadding='0'><tr>");
            ...
            if(id.compareTo("-1")==0){
                ...
                out.println("<td><input type='button' value='convertir en Personalizacion' onclick=\"PedidoPersonalizacion('"+id_pedido_detalle+"');\"></td>");
            }
