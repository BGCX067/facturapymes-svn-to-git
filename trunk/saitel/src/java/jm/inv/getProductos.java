...
public class getProductos extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ResultSet rsProductos = enter.compareTo("13")==0 ? objProducto.getProductoFiltro(texto) : objProducto.getProductosFiltro(texto);
            out.print("obj»ax^fun»"+funcion+"('"+objProducto.getJSON(rsProductos)+"', "+enter+")");
            try{
                rsProductos.close();
            }catch(Exception e){
                e.printStackTrace();
