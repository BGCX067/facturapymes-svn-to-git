 ...
 * @author Jorge
 */
public class pdfLiquidaciones extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        float anchoTabla[] = new float[]{25f,70f,160f,80f,60f,50f,40f,30f,30f,30f,40f};

        Reporte reporte = new Reporte(false, logo, titulo, ruc, subtitulo, direccion, "", rep_pie);
        reporte.liquidaciones(response, cabTabla, anchoTabla, registros, objDB);
