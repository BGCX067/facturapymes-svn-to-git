 ...
 * @author Jorge
 */
public class retencionEmitidaAnular extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            try{
                ResultSet rsFactura = objFacturaCompra.getFacturaRetencion(id);
                if(rsFactura.next()){
            ...
            if(objFacturaCompra.anularRetencion(idFact, id)){
                Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                auditoria.setRegistro(request, "ANULACION DEL COMPROBANTE DE RETENCION EMITIDO CON Nro. "+num_serie_ret+"-"+num_retencion);
                auditoria.cerrar();
