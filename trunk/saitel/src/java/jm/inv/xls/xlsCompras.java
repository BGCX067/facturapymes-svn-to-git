 ...
 * @author Jorge
 */
public class xlsCompras extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        ResultSet registros = objDB.consulta("select id_factura_compra,ruc,razon_social,numero_factura,autorizacion,toDateSQL(fecha_compra),subtotal,descuento,subtotal_0,iva_2,total_compra "
        ...
        String xls = reporte.compras(subtitulo, cabTabla, registros, objDB);
