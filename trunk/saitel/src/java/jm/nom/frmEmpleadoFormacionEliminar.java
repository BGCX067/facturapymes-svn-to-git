 ...
 * @author Jorge
 */
public class frmEmpleadoFormacionEliminar extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(objEmpleado.eliminarformacion(id)){
                    Auditoria auditoria = new Auditoria(this._ip, this._puerto, this._db, usuario, clave);
                    auditoria.setRegistro(request, "ELIMINACION DE LA FORMACION: "+formacion+" DEL EMPLEADO: "+empleado);
                    auditoria.cerrar();
                }else{
