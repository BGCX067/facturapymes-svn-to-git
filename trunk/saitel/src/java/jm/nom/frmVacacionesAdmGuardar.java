 ...
 * @author Jorge
 */
public class frmVacacionesAdmGuardar extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String fechaPermiso=request.getParameter("fechaInicio");
            ...
            if(objPermisosLicencias.actualizarVacaciones(id,permisoEstado,descripcion, usuario)){
                try{
                ...
                mensaje.append("A través de la presente me dirijo a usted a fin de comunicarle que el permiso de vacación del día "+fechaPermiso+" está "+permisoEstado+""
                        + ", por el siguiente motivo: "+descripcion);
                mensaje.append("<br><br>Atentamente:<br> "+nombreJefe);
                if(Correo.enviar(servidor_mail, "marcolopez@saitel.ec",email , emailJefeSucursal, email, "RESPUESTA AL PEDIDO DE VACACIONES PARA "+nombre+" "+apellido, mensaje, true)){
