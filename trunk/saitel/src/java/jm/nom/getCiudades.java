...
public class getCiudades extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            String idPadre = request.getParameter("idP");
            String obj = request.getParameter("obj");
            String idObj = request.getParameter("id");
            String func = request.getParameter("fun");
            String fun = "";
            if(func.compareTo("")!=0){
                fun = "^fun»nom_setUbicacion(_('id_ciudad').value, 'id_parroquia', 'auxParr', '')";
            }
            ResultSet rsCiudades = objUbicacion.getUbicaciones(idPadre);
            out.print("obj»"+obj+fun+"^frm»"+DatosDinamicos.combo(rsCiudades, idObj, "", func, "", 150));
            try{
                rsCiudades.close();
            }catch(Exception e){
                e.printStackTrace();
