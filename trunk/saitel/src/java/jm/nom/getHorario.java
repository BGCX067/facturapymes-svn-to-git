 ...
 * @author Jorge
 */
public class getHorario extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            String fun = "";
            ResultSet rsHorario = objHorario.getHorarioCombo(idPadre);
            out.print("obj»"+obj+fun+"^frm»"+DatosDinamicos.combo(rsHorario, idObj, "", func, "", 150));
            try{
                rsHorario.close();
            }catch(Exception e){
                e.printStackTrace();
