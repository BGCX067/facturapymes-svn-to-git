 ...
 * @author Jorge
 */
public class pdfEmpleados extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        ResultSet registros = objDB.consulta("select departamento,ac_no, dni,empleado,txt_sexo,txt_estado_civil,direccion,edad,telefono,movil,email,ciudad,nacionalidad from vta_empleado "+WHERE+" order by departamento,ciudad,empleado");
        ...
        String [] cabTabla = new String [] {"Nro.", "#", "AC No", "IDENTIF.", "NOMBRES", "GENERO", "ESTADO CIVIL", "DIRECCION", "EDAD", "TELF.", "MOVIL", "EMAIL", "CIUDAD", "NACIONALIDAD"};
        float [] anchoTabla = new float[]{20f,20f,20f, 55f,100f,55f,65f,100f,20f,45f,45f,70f,50f,70f};
