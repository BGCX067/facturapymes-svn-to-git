 ...
 * @author Jorge
 */
public class xlsAreas extends HttpServlet {
    ...
    */
    ...
    throws ServletException, IOException {
        ...
        ResultSet registros = objDB.consulta("select area from tbl_area "+WHERE+" order by area");
        String subtitulo = "Listado de áreas (departamentos).";
        ReporteXls reporte = new ReporteXls();
        String [] cabTabla = new String [] {"Nro.", "AREA"};
        String xls = reporte.lista(subtitulo, cabTabla, registros, 3);
