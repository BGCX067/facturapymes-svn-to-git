 ...
 */
    ...
    {
        String sel="";        
        String cad="<select id=\""+nom+"\" name=\""+nom+"\" onchange=\""+onC+"\">";
        for(int i=0; i<opt.length; i++){
            sel = (opt[i][0].compareTo(mar)==0) ? "selected" : "";
            cad+="<option "+sel+" value=\"" + opt[i][0] + "\">" + opt[i][1] + "</option>";
        }
        cad+="</select>"; 
        return cad;
    }
 ...
 */
    public static String combo(ResultSet dat, String nom, String mar, String onC)
    {
        ...
        try{
            ...
            while(dat.next()){
                ...
                cad+="<option "+sel+" value=\"" + dat.getString(1) + "\">" + et + "</option>";
                et="";
            }
            dat.beforeFirst();
        }catch(Exception e){
    ...
    {
        String sel="";        
        String cad="<optgroup label='No Disponibles'>";
        try{
            ResultSetMetaData mdata = dat.getMetaData();
            int lim = mdata.getColumnCount();
            String et="";
            ...
            while(dat.next()){
                ...
                cad+="<option "+sel+" value=\"" + dat.getString(1) + "\" disabled>" + et + "</option>";
                et="";
            }
            dat.beforeFirst();
        }catch(Exception e){
 ...
 */
    ...
    {
        String sel="";        
        String cad="<select id=\""+nom+"\" name=\""+nom+"\" onchange=\""+onC+"\" style=\"width:"+anch+"px\">";
        try{
            ResultSetMetaData mdata = dat.getMetaData();
            int lim = mdata.getColumnCount();
            String et="";
 ...
 */
    ...
    {
        String sel="";        
        String cad="<select id=\""+nom+"\" name=\""+nom+"\" onchange=\""+onC+"\" "+activo+" style=\"width:"+anch+"px\">";
        try{
            ResultSetMetaData mdata = dat.getMetaData();
            int lim = mdata.getColumnCount();
            String et="";
 ...
 */
    ...
    {
        String sel="";        
        String cad="<select id=\""+nom+"\" name=\""+nom+"\" onchange=\""+onC+"\" style=\"width:"+anch+"px\" "+estado+">";
        if(opt.compareTo("")!=0){
            cad+="<option value='-0'>" + opt + "</option>";
        }
        try{
    ...
    {
        String sel="";        
        String cad="<select id=\""+nom+"\" name=\""+nom+"\" style=\"width:"+anch+"px\" onfocus=\""+onFoc+"\" onkeyup=\""+evt+"\" onchange=\""+onCh+"\" " +
                "onblur=\"_R('mSg')\">";
                // "onblur=\"_('mSg').style.display='none'\">"; 
        if(opt.compareTo("")!=0){
            cad+="<option value='-0' onmousemove=\""+evt+"\" >" + opt + "</option>";
        }
        try{
            ResultSetMetaData mdata = dat.getMetaData();
            int lim = mdata.getColumnCount();
            ...
            while(dat.next()){
                ...
                cad+="<option "+sel+" value=\"" + dat.getString(1) + "\" onmousemove=\""+evt+"\" >" + et + "</option>";
                et="";
            }
            dat.beforeFirst();
        }catch(Exception e){
