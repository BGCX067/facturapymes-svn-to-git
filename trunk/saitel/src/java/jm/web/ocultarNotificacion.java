 ...
 */
public class ocultarNotificacion extends HttpServlet {
...
*/
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if(db.ejecutar("insert into tbl_mensaje_usuario(usuario, id_mensaje) values('"+usuario+"', "+id+")")){
                out.print("fun»_R('id_notf"+id+"');_R('id_notf_sep"+id+"');");
            }else{
                out.print("");
            }
        } finally {
